    ...
    return ( 
        <div className="w-full h-1/3 group flex">
            ...
            <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300
                rounded-lg p-4 lg:px-10 flex flex-col justify-center gap-6 lg:gap-10 shadow-shadowOne"
            >
                <div className="flex flex-row lg:items-center gap-4 lg:gap-0 justify-between"> 
                    <div>
                        <h3 className="text-xl lg:text-2xl font-semibold group-hover:text-white duration-300">
                            {title}
                        </h3>
...
// STOPED AT 1:42:50 ********************************************************
// https://www.youtube.com/watch?v=lJ2EBYN0C70
